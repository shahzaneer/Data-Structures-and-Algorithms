...
// here we will implement special enqueue function 
// the dequeue function will be normal
// 
...
PriorityQueue *q = NULL; // making of a global pointer
...
void enqueue(int value)
{
    ...
    {
        if(q->arr[q->rear] > q->arr[q->rear + 1  % q->size]){
...
int main()
{
    q = new PriorityQueue; // DMA things
    int size;
